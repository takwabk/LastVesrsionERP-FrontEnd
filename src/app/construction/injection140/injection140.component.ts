...
export class Injection140Component implements OnInit {
  ...
  ngOnInit() {
    this.id = "614463456c0478445c9082e7";
  ...
  Tab_140: any = {
    ...
    totaux_SS_traitance_Total_140: "",
    totaux_marge_Total_140: "",
    totaux_prixVente_Total_140: "",
  };
    ...
    let ssTraitance =
      (this.Tab_140.Ouverture_chantier.Controle_technique_SPS.SS_Traitance =
        this.isNullOrVideGetFromBase(
          this.Tab_140.Ouverture_chantier.Controle_technique_SPS.SS_Traitance,
          this. conceptions[0].Tab_140.Ouverture_chantier.Controle_technique_SPS
            .SS_Traitance
        ));
  ...
  somme_privVente_chantier() {
    ...
    return this.Tab_140.Ouverture_chantier.Controle_technique_SPS
      .Prix_vente_Concep;
  }
  ...
  sommeDeMarge_frais() {
    let ssTraitance =
      (this.Tab_140.Ouverture_chantier.Frais_dossier.SS_Traitance =
        this.isNullOrVideGetFromBase(
          this.Tab_140.Ouverture_chantier.Frais_dossier.SS_Traitance,
          this. conceptions[0].Tab_140.Ouverture_chantier.Frais_dossier
            .SS_Traitance
        ));
    ...
    let margeEuro = (this.Tab_140.Ouverture_chantier.Frais_dossier.marge_euro =
      this.isNullOrVideGetFromBase(
        this.Tab_140.Ouverture_chantier.Frais_dossier.marge_euro,
        this. conceptions[0].Tab_140.Ouverture_chantier.Frais_dossier.marge_euro
      ));
  ...
  sommeDeMarge_conseil() {
    let ssTraitance =
      (this.Tab_140.Ouverture_chantier.Conseil_suivi.SS_Traitance =
        this.isNullOrVideGetFromBase(
          this.Tab_140.Ouverture_chantier.Conseil_suivi.SS_Traitance,
          this. conceptions[0].Tab_140.Ouverture_chantier.Conseil_suivi
            .SS_Traitance
        ));
    ...
    let margeEuro = (this.Tab_140.Ouverture_chantier.Conseil_suivi.marge_euro =
      this.isNullOrVideGetFromBase(
        this.Tab_140.Ouverture_chantier.Conseil_suivi.marge_euro,
        this. conceptions[0].Tab_140.Ouverture_chantier.Conseil_suivi.marge_euro
      ));
  ...
  sommeDeMarge_aleas() {
    let ssTraitance = (this.Tab_140.Ouverture_chantier.Aleas.SS_Traitance =
      this.isNullOrVideGetFromBase(
        this.Tab_140.Ouverture_chantier.Aleas.SS_Traitance,
        this. conceptions[0].Tab_140.Ouverture_chantier.Aleas.SS_Traitance
      ));

    let margePercent = (this.Tab_140.Ouverture_chantier.Aleas.marge_percent =
      this.isNullOrVideGetFromBase(
        this.Tab_140.Ouverture_chantier.Aleas.marge_percent,
        this. conceptions[0].Tab_140.Ouverture_chantier.Aleas.marge_percent
      ));

    let margeEuro = (this.Tab_140.Ouverture_chantier.Aleas.marge_euro =
      this.isNullOrVideGetFromBase(
        this.Tab_140.Ouverture_chantier.Aleas.marge_euro,
        this. conceptions[0].Tab_140.Ouverture_chantier.Aleas.marge_euro
      ));
  ...
  somme_privVente_aleas() {
    ...
    let marge_totale = (this.Tab_140.Ouverture_chantier.Aleas.marge_totale =
      this.readFromUserElseFromBase(
  ...
  sommeDeMarge_TRCME() {
    let ssTraitance = (this.Tab_140.Ouverture_chantier.TRCME.SS_Traitance =
      this.isNullOrVideGetFromBase(
        this.Tab_140.Ouverture_chantier.TRCME.SS_Traitance,
        this. conceptions[0].Tab_140.Ouverture_chantier.TRCME.SS_Traitance
      ));

    let margePercent = (this.Tab_140.Ouverture_chantier.TRCME.marge_percent =
      this.isNullOrVideGetFromBase(
        this.Tab_140.Ouverture_chantier.TRCME.marge_percent,
        this. conceptions[0].Tab_140.Ouverture_chantier.TRCME.marge_percent
      ));

    let margeEuro = (this.Tab_140.Ouverture_chantier.TRCME.marge_euro =
      this.isNullOrVideGetFromBase(
        this.Tab_140.Ouverture_chantier.TRCME.marge_euro,
        this. conceptions[0].Tab_140.Ouverture_chantier.TRCME.marge_euro
      ));
  ...
  somme_privVente_TRCME() {
    ...
    let marge_totale = (this.Tab_140.Ouverture_chantier.TRCME.marge_totale =
      this.readFromUserElseFromBase(
  ...
  sommeDeMarge_achat() {
    let ssTraitance =
      (this.Tab_140.Ouverture_chantier.Achat_Terrain.SS_Traitance =
        this.isNullOrVideGetFromBase(
          this.Tab_140.Ouverture_chantier.Achat_Terrain.SS_Traitance,
          this. conceptions[0].Tab_140.Ouverture_chantier.Achat_Terrain
            .SS_Traitance
        ));
    ...
    let margeEuro = (this.Tab_140.Ouverture_chantier.Achat_Terrain.marge_euro =
      this.isNullOrVideGetFromBase(
        this.Tab_140.Ouverture_chantier.Achat_Terrain.marge_euro,
        this. conceptions[0].Tab_140.Ouverture_chantier.Achat_Terrain.marge_euro
      ));
  ...
  sommeDeMarge_notaire() {
    let ssTraitance =
      (this.Tab_140.Ouverture_chantier.Frais_notaire.SS_Traitance =
        this.isNullOrVideGetFromBase(
          this.Tab_140.Ouverture_chantier.Frais_notaire.SS_Traitance,
          this. conceptions[0].Tab_140.Ouverture_chantier.Frais_notaire
            .SS_Traitance
        ));
    ...
    let margeEuro = (this.Tab_140.Ouverture_chantier.Frais_notaire.marge_euro =
      this.isNullOrVideGetFromBase(
        this.Tab_140.Ouverture_chantier.Frais_notaire.marge_euro,
        this. conceptions[0].Tab_140.Ouverture_chantier.Frais_notaire.marge_euro
      ));
  ...
  somePrixDeVneteTotaux_TAB1() {
    ...
    let Prix_vente_Concep_Aleas =
      (this.Tab_140.Ouverture_chantier.Aleas.Prix_vente_Concep =
        this.isNullOrVideGetFromBase(
          this.Tab_140.Ouverture_chantier.Aleas.Prix_vente_Concep,
          this. conceptions[0].Tab_140.Ouverture_chantier.Aleas.Prix_vente_Concep
        ));
    let Prix_vente_Concep_TRCME =
      (this.Tab_140.Ouverture_chantier.TRCME.Prix_vente_Concep =
        this.isNullOrVideGetFromBase(
          this.Tab_140.Ouverture_chantier.TRCME.Prix_vente_Concep,
          this. conceptions[0].Tab_140.Ouverture_chantier.TRCME.Prix_vente_Concep
        ));
  ...
  somme_privVente_2TAB2() {
    ...
    return (this.Tab_140.Lot_1_Process_methanisation.Pieces_usure_premiere_urgence_Lot_1.Prix_vente_Concep =
      ssTraitance + marge_totale);
  }
  ...
  somePrixDeVneteTotaux_TAB2() {
    let Sous_Total_Prix_vente_proMetha =
      (this.Tab_140.Lot_1_Process_methanisation.Process_methanisation.Prix_vente_Concep =
        this.isNullOrVideGetFromBase(
          this.Tab_140.Lot_1_Process_methanisation.Process_methanisation
            .Prix_vente_Concep,
          this. conceptions[0].Tab_140.Lot_1_Process_methanisation
  ...
  sommeDeMarge_TAB3() {
    ...
    return (this.Tab_140.Lot_2_Valorisation.Epuration_Compression_Chaudiere.marge_totale =
      this.produit2(ssTraitance, this.quotion(marge_percent, 100)) +
      marge_euro);
  }
  ...
  sommeDeMarge_2TAB3() {
    ...
    let marge_euro = (this.Tab_140.Lot_2_Valorisation.Cogenerateur.marge_euro =
      this.isNullOrVideGetFromBase(
        this.Tab_140.Lot_2_Valorisation.Cogenerateur.marge_euro,
        this. conceptions[0].Tab_140.Lot_2_Valorisation.Cogenerateur.marge_euro
      ));
  ...
  somePrixDeVneteTotaux_TAB3() {
    let Sous_Total_Prix_vente_epucc =
      (this.Tab_140.Lot_2_Valorisation.Epuration_Compression_Chaudiere.Prix_vente_Concep =
        this.isNullOrVideGetFromBase(
          this.Tab_140.Lot_2_Valorisation.Epuration_Compression_Chaudiere
            .Prix_vente_Concep,
          this. conceptions[0].Tab_140.Lot_2_Valorisation
  ...
  somePrixDeVneteTotaux_TAB4() {
    let Sous_Total_Prix_vente =
      (this.Tab_140.Lot_3_Terrassement_Grande_Masse_Talutage_VRD.Terrassement_Grande_Masse_Talutafe_VRD.Prix_vente_Concep =
        this.isNullOrVideGetFromBase(
          this.Tab_140.Lot_3_Terrassement_Grande_Masse_Talutage_VRD
  ...
  somePrixDeVneteTotaux_TAB5() {
    let Sous_Total_Prix_vente =
      (this.Tab_140.Lot_4_Genie_Civil_circulaire_digestat_liquide_couverture_simple.Genie_Civil_circulaire_digestat_liquide_couverture_simple.Prix_vente_Concep =
        this.isNullOrVideGetFromBase(
          this.Tab_140
            .Lot_4_Genie_Civil_circulaire_digestat_liquide_couverture_simple
            .Genie_Civil_circulaire_digestat_liquide_couverture_simple
  ...
  somePrixDeVneteTotaux_TAB7() {
    let Sous_Total_Prix_vente =
      (this.Tab_140.Lot_6_Charpente_Batiment_Couverture.Charpente_Batiment_Couverture.Prix_vente_Concep =
        this.isNullOrVideGetFromBase(
          this.Tab_140.Lot_6_Charpente_Batiment_Couverture
  ...
  somePrixDeVneteTotaux_TAB8() {
    let Sous_Total_Prix_vente =
      (this.Tab_140.Lot_7_Courant_fort_Soutirage_Electricite_Generale.Courant_fort_Soutirage_Electricite_Generale.Prix_vente_Concep =
        this.isNullOrVideGetFromBase(
          this.Tab_140.Lot_7_Courant_fort_Soutirage_Electricite_Generale
  ...
  //TAB 9
  sommeDeMarge_TAB9() {
    let ssTraitance = (this.Tab_140.Maitrise_oevre.Maitrise_oevre.SS_Traitance =
      this.isNullOrVideGetFromBase(
    ...
    let marge_euro = (this.Tab_140.Maitrise_oevre.Maitrise_oevre.marge_euro =
      this.isNullOrVideGetFromBase(
  ...
  somme_privVente_TAB9() {
    ...
    let marge_totale =
      (this.Tab_140.Maitrise_oevre.Maitrise_oevre.marge_totale =
        this.readFromUserElseFromBase(
          this.Tab_140.Maitrise_oevre.Maitrise_oevre.marge_totale,
          this. conceptions[0].Tab_140.Maitrise_oevre.Maitrise_oevre.marge_totale
        ));
  ...
  sommeSoutraitanceTotaux_TAB9() {
    ...
    return (this.Tab_140.Maitrise_oevre.Sous_Total_Construction = SS_Traitance);
  }
  ...
  sommeDeMarge_TAB10() {
    ...
    let marge_euro = (this.Tab_140.Assistance_maitrise_ouvrage.AMO.marge_euro =
      this.isNullOrVideGetFromBase(
        this.Tab_140.Assistance_maitrise_ouvrage.AMO.marge_euro,
        this. conceptions[0].Tab_140.Assistance_maitrise_ouvrage.AMO.marge_euro
      ));
  ...
  sommeDeMarge_TAB11() {
    let ssTraitance = (this.Tab_140.Materiel.Matrriels_agricoles.SS_Traitance =
      this.isNullOrVideGetFromBase(
    ...
    let margePercent =
      (this.Tab_140.Materiel.Matrriels_agricoles.marge_percent =
        this.isNullOrVideGetFromBase(
          this.Tab_140.Materiel.Matrriels_agricoles.marge_percent,
          this. conceptions[0].Tab_140.Materiel.Matrriels_agricoles.marge_percent
        ));

    let margeEuro = (this.Tab_140.Materiel.Matrriels_agricoles.marge_euro =
      this.isNullOrVideGetFromBase(
  ...
  somme_privVente_TAB11() {
    ...
    var marge_totale = (this.Tab_140.Materiel.Matrriels_agricoles.marge_totale =
      this.readFromUserElseFromBase(
        this.Tab_140.Materiel.Matrriels_agricoles.marge_totale,
        this. conceptions[0].Tab_140.Materiel.Matrriels_agricoles.marge_totale
      ));

    this.Tab_140.Materiel.Matrriels_agricoles.Prix_vente_Concep =
      ssTraitance + marge_totale;

    return this.Tab_140.Materiel.Matrriels_agricoles.Prix_vente_Concep;
  }
  ...
  somme_privVente_2TAB1() {
    ...
    return this.Tab_140.Materiel.Pont_bascule_Reserve_Incendie
      .Prix_vente_Concep;
  }
  sommeDeMarge_3TAB11() {
    let ssTraitance = (this.Tab_140.Materiel.Hygenisiation.SS_Traitance =
      this.isNullOrVideGetFromBase(
        this.Tab_140.Materiel.Hygenisiation.SS_Traitance,
        this. conceptions[0].Tab_140.Materiel.Hygenisiation.SS_Traitance
      ));

    let margePercent = (this.Tab_140.Materiel.Hygenisiation.marge_percent =
      this.isNullOrVideGetFromBase(
        this.Tab_140.Materiel.Hygenisiation.marge_percent,
        this. conceptions[0].Tab_140.Materiel.Hygenisiation.marge_percent
      ));

    let margeEuro = (this.Tab_140.Materiel.Hygenisiation.marge_euro =
      this.isNullOrVideGetFromBase(
  ...
  somme_privVente_3TAB11() {
    ...
    var marge_totale = (this.Tab_140.Materiel.Hygenisiation.marge_totale =
      this.readFromUserElseFromBase(
        this.Tab_140.Materiel.Hygenisiation.marge_totale,
  ...
  sommeDeMarge_4TAB11() {
    let ssTraitance = (this.Tab_140.Materiel.Semi_remorque_44_t.SS_Traitance =
      this.isNullOrVideGetFromBase(
        this.Tab_140.Materiel.Semi_remorque_44_t.SS_Traitance,
        this. conceptions[0].Tab_140.Materiel.Semi_remorque_44_t.SS_Traitance
      ));

    let margePercent = (this.Tab_140.Materiel.Semi_remorque_44_t.marge_percent =
      this.isNullOrVideGetFromBase(
    ...
    let margeEuro = (this.Tab_140.Materiel.Semi_remorque_44_t.marge_euro =
      this.isNullOrVideGetFromBase(
  ...
  somme_privVente_4TAB11() {
    ...
    var marge_totale = (this.Tab_140.Materiel.Semi_remorque_44_t.marge_totale =
      this.readFromUserElseFromBase(
        this.Tab_140.Materiel.Semi_remorque_44_t.marge_totale,
  ...
  someMargeTotaux_TAB11() {
    let marge_totale = (this.Tab_140.Materiel.Matrriels_agricoles.marge_totale =
      this.isNullOrVideGetFromBase(
        this.Tab_140.Materiel.Matrriels_agricoles.marge_totale,
        this. conceptions[0].Tab_140.Materiel.Matrriels_agricoles.marge_totale
      ));
    ...
    let marge_totale__ = (this.Tab_140.Materiel.Hygenisiation.marge_totale =
      this.isNullOrVideGetFromBase(
        this.Tab_140.Materiel.Hygenisiation.marge_totale,
        this. conceptions[0].Tab_140.Materiel.Hygenisiation.marge_totale
      ));
    let _marge_totale = (this.Tab_140.Materiel.Semi_remorque_44_t.marge_totale =
      this.isNullOrVideGetFromBase(
        this.Tab_140.Materiel.Semi_remorque_44_t.marge_totale,
        this. conceptions[0].Tab_140.Materiel.Semi_remorque_44_t.marge_totale
      ));
  ...
  somePrixDeVneteTotaux_TAB11() {
    ...
    let Prix_vente_Concep_Conseil_suivi =
      (this.Tab_140.Materiel.Hygenisiation.Prix_vente_Concep =
        this.isNullOrVideGetFromBase(
          this.Tab_140.Materiel.Hygenisiation.Prix_vente_Concep,
          this. conceptions[0].Tab_140.Materiel.Hygenisiation.Prix_vente_Concep
        ));
    let Prix_vente_Concep_Aleas =
      (this.Tab_140.Materiel.Semi_remorque_44_t.Prix_vente_Concep =
        this.isNullOrVideGetFromBase(
  ...
  //     ) +
  //     this.isNanFunction(
  //       this.Tab_140.Lot_6_Charpente_Batiment_Couverture.Sous_Total_Prix_vente
  //     ) +
  //     this.isNanFunction(
  //       this.Tab_140.Lot_7_Courant_fort_Soutirage_Electricite_Generale
  //         .Sous_Total_Prix_vente
  ...
  //     this.isNanFunction(this.Tab_140.Tab_140.Lot_3_Terrassement_Grande_Masse_Talutage_VRD.Marge_totaux) +
  //     this.isNanFunction(
  //       this.Tab_140
  //         .Lot_4_Genie_Civil_circulaire_digestat_liquide_couverture_simple
  //         .Marge_totaux
  ...
  // }
  SommeTotal_totaux_SS_Traitance(){
    this.Tab_140.totaux_SS_traitance_Total_140=0


   return (this.Tab_140.totaux_SS_traitance_Total_140=
    this.isNanFunction(this.Tab_140.Ouverture_chantier.Sous_Total_Conception)+
    this.isNanFunction(this.Tab_140.Lot_1_Process_methanisation.Sous_Total_Conception)+
    this.isNanFunction(this.Tab_140.Lot_2_Valorisation.Sous_Total_Conception)+
    this.isNanFunction(this.Tab_140.Lot_3_Terrassement_Grande_Masse_Talutage_VRD.Sous_Total_Conception)+
    this.isNanFunction(this.Tab_140.Lot_4_Genie_Civil_circulaire_digestat_liquide_couverture_simple.Sous_Total_Conception)+
    this.isNanFunction(this.Tab_140.Lot_5_Genie_Civil_ouvrages_peripheriques.Sous_Total_Conception)+
    this.isNanFunction(this.Tab_140.Lot_6_Charpente_Batiment_Couverture.Sous_Total_Conception)+

    this.isNanFunction(this.Tab_140.Lot_7_Courant_fort_Soutirage_Electricite_Generale.Sous_Total_Conception)+
    this.isNanFunction(this.Tab_140.Maitrise_oevre.Sous_Total_Conception)+
    this.isNanFunction(this.Tab_140.Assistance_maitrise_ouvrage.Sous_Total_Conception)+
    this.isNanFunction(this.Tab_140.Materiel.Sous_Total_Conception)

   );
  }
  SommeTotal_totaux_Prix_Vente_totaux(){
    this.Tab_140.totaux_prixVente_Total_140=0
    return (this.Tab_140.totaux_prixVente_Total_140=
     this.isNanFunction(this.Tab_140.Ouverture_chantier.Sous_Total_Prix_vente_Concep)+
     this.isNanFunction(this.Tab_140.Lot_1_Process_methanisation.Sous_Total_Prix_vente_Concep)+
     this.isNanFunction(this.Tab_140.Lot_2_Valorisation.Sous_Total_Prix_vente_Concep)+
     this.isNanFunction(this.Tab_140.Lot_3_Terrassement_Grande_Masse_Talutage_VRD.Sous_Total_Prix_vente_Concep)+
     this.isNanFunction(this.Tab_140.Lot_4_Genie_Civil_circulaire_digestat_liquide_couverture_simple.Sous_Total_Prix_vente_Concep)+
     this.isNanFunction(this.Tab_140.Lot_5_Genie_Civil_ouvrages_peripheriques.Sous_Total_Prix_vente_Concep)+
     this.isNanFunction(this.Tab_140.Lot_6_Charpente_Batiment_Couverture.Sous_Total_Prix_vente_Concep)+

     this.isNanFunction(this.Tab_140.Lot_7_Courant_fort_Soutirage_Electricite_Generale.Sous_Total_Prix_vente_Concep)+
     this.isNanFunction(this.Tab_140.Maitrise_oevre.Sous_Total_Prix_vente_Concep)+
     this.isNanFunction(this.Tab_140.Assistance_maitrise_ouvrage.Sous_Total_Prix_vente_Concep)+
     this.isNanFunction(this.Tab_140.Materiel.Sous_Total_Prix_vente_Concep)

    );
  }
  SommeTotal_totaux_Marge_totaux(){
    this.Tab_140.totaux_marge_Total_140=0
    return (this.Tab_140.totaux_marge_Total_140=
     this.isNanFunction(this.Tab_140.Ouverture_chantier.Marge_totaux)+
     this.isNanFunction(this.Tab_140.Lot_1_Process_methanisation.Marge_totaux)+
     this.isNanFunction(this.Tab_140.Lot_2_Valorisation.Marge_totaux)+
     this.isNanFunction(this.Tab_140.Lot_3_Terrassement_Grande_Masse_Talutage_VRD.Marge_totaux)+
