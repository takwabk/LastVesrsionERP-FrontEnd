...
export class Injection190Component implements OnInit {
  ...
  ngOnInit() {
    this.id = "613b0cea4d45310950deda7e";
  ...
  sommeDeMarge_chantier() {
    if (
      ...
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Controle_technique_SPS.marge_percent);
      this.Tab_190.Ouverture_chantier.Controle_technique_SPS.marge_euro =
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Controle_technique_SPS.marge_euro);
    }
    ...
    var ssTraitance = this.isNanFunction(
      ...
      : this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Controle_technique_SPS
          .SS_Traitance);
  ...
  somme_privVente_chantier(){
    ...
    if (
      ...
      this.Tab_190.Ouverture_chantier.Controle_technique_SPS.SS_Traitance =
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Controle_technique_SPS.SS_Traitance);;
      this.Tab_190.Ouverture_chantier.Controle_technique_SPS.marge_totale =
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Controle_technique_SPS.marge_totale);
    }
...
console.log("l-379 m s p", typeof marge_totale,typeof ssTraitance,typeof this.Tab_190.Ouverture_chantier.Controle_technique_SPS.Prix_vente)
  this.Tab_190.Ouverture_chantier.Controle_technique_SPS.Prix_vente_Concep =
    this.isNanFunction(ssTraitance + marge_totale);
    console.log("yeeeeessss", this.Tab_190.Ouverture_chantier.Controle_technique_SPS.Prix_vente_Concep);
...
return this.Tab_190.Ouverture_chantier.Controle_technique_SPS.Prix_vente_Concep;
  ...
  sommeDeMarge_frais() {
    if (
      ...
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Frais_dossier.marge_percent);
      this.Tab_190.Ouverture_chantier.Frais_dossier.marge_euro =
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Frais_dossier.marge_euro);
    }
    ...
    var ssTraitance = this.isNanFunction(
      ...
      : this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Frais_dossier
          .SS_Traitance);
  ...
  somme_privVente_frais(){
    ...
    if (
      ...
      this.Tab_190.Ouverture_chantier.Frais_dossier.SS_Traitance =
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Frais_dossier.SS_Traitance);
      this.Tab_190.Ouverture_chantier.Frais_dossier.marge_totale =

      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Frais_dossier.marge_totale);
    }
  ...
  sommeDeMarge_conseil() {
    if (
      ...
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Conseil_suivi.marge_percent);
      this.Tab_190.Ouverture_chantier.Conseil_suivi.marge_euro =
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Conseil_suivi.marge_euro);
    }
    ...
    var ssTraitance = this.isNanFunction(
      ...
      : this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Conseil_suivi
          .SS_Traitance);
  ...
  somme_privVente_conseil(){
    ...
    if (
      ...
      this.Tab_190.Ouverture_chantier.Conseil_suivi.SS_Traitance =
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Conseil_suivi.SS_Traitance);
      this.Tab_190.Ouverture_chantier.Conseil_suivi.marge_totale =

      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Conseil_suivi.marge_totale);
    }
  ...
  sommeDeMarge_aleas() {
    if (
      ...
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Aleas.marge_percent);
      this.Tab_190.Ouverture_chantier.Aleas.marge_euro =
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Aleas.marge_euro);
    }
    ...
    var ssTraitance = this.isNanFunction(
      ...
      : this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Aleas
          .SS_Traitance);
  ...
  somme_privVente_aleas(){
    ...
    if (
      ...
      this.Tab_190.Ouverture_chantier.Aleas.SS_Traitance =
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Aleas.SS_Traitance);
      this.Tab_190.Ouverture_chantier.Aleas.marge_totale =

      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Aleas.marge_totale);
    }
  ...
  sommeDeMarge_TRCME() {
    if (
      ...
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.TRCME.marge_percent);
      this.Tab_190.Ouverture_chantier.TRCME.marge_euro =
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.TRCME.marge_euro);
    }
    ...
    var ssTraitance = this.isNanFunction(
      ...
      : this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.TRCME
          .SS_Traitance);
  ...
  somme_privVente_TRCME(){
    ...
    if (
      ...
      this.Tab_190.Ouverture_chantier.TRCME.SS_Traitance =
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.TRCME.SS_Traitance);
      this.Tab_190.Ouverture_chantier.TRCME.marge_totale =

      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.TRCME.marge_totale);
    }
 ...
 sommeDeMarge_achat() {
    if (
      ...
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Achat_Terrain.marge_percent);
      this.Tab_190.Ouverture_chantier.Achat_Terrain.marge_euro =
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Achat_Terrain.marge_euro);
    }
    ...
    var ssTraitance = this.isNanFunction(
      ...
      : this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Achat_Terrain
          .SS_Traitance);
  ...
  somme_privVente_achat(){
    ...
    if (
      ...
      this.Tab_190.Ouverture_chantier.Achat_Terrain.SS_Traitance =
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Achat_Terrain.SS_Traitance);
      this.Tab_190.Ouverture_chantier.Achat_Terrain.marge_totale =

      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Achat_Terrain.marge_totale);
    }
  ...
  sommeDeMarge_notaire() {
    if (
      ...
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Frais_notaire.marge_percent);
      this.Tab_190.Ouverture_chantier.Frais_notaire.marge_euro =
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Frais_notaire.marge_euro);
    }
    ...
    var ssTraitance = this.isNanFunction(
      ...
      : this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Frais_notaire
          .SS_Traitance);
  ...
  somme_privVente_notaire(){
    ...
    if (
      ...
      this.Tab_190.Ouverture_chantier.Frais_notaire.SS_Traitance =
      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Frais_notaire.SS_Traitance);
      this.Tab_190.Ouverture_chantier.Frais_notaire.marge_totale =

      this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Frais_notaire.marge_totale);
    }
  ...
  someMargeTotaux_TAB1(){
    ...
    if (
      ...
      this.Tab_190.Ouverture_chantier.Controle_technique_SPS.marge_totale =
        this.isNanFunction(
          this.conceptions[1].Tab_190.Ouverture_chantier.Controle_technique_SPS.marge_totale
        );

      this.Tab_190.Ouverture_chantier.Frais_dossier.marge_totale =
        this.isNanFunction(
          this.conceptions[1].Tab_190.Ouverture_chantier.Frais_dossier.marge_totale
        );

      this.Tab_190.Ouverture_chantier.Conseil_suivi.marge_totale =
        this.isNanFunction(
          this.conceptions[1].Tab_190.Ouverture_chantier.Conseil_suivi.marge_totale
        );
      ...
      this.Tab_190.Ouverture_chantier.Aleas.marge_totale =
        ...
        this.Tab_190.Ouverture_chantier.Achat_Terrain.marge_totale =
        this.isNanFunction(
          this.conceptions[1].Tab_190.Ouverture_chantier.Achat_Terrain.marge_totale
        );
        this.Tab_190.Ouverture_chantier.Frais_notaire.marge_totale =
        this.isNanFunction(
          this.conceptions[1].Tab_190.Ouverture_chantier.Frais_notaire.marge_totale
        );
    }
    ...
    var s0 = this.isNanFunction(
      this.Tab_190.Ouverture_chantier.Marge_totaux
    );
  ...
  sommeSoutraitanceTotaux_TAB1(){
    if (
      ...
      this.Tab_190.Ouverture_chantier.Controle_technique_SPS.SS_Traitance =
        this.isNanFunction(
          this.conceptions[1].Tab_190.Ouverture_chantier.Controle_technique_SPS.SS_Traitance
        );

      this.Tab_190.Ouverture_chantier.Frais_dossier.SS_Traitance =
        this.isNanFunction(
          this.conceptions[1].Tab_190.Ouverture_chantier.Frais_dossier.SS_Traitance
        );

      this.Tab_190.Ouverture_chantier.Conseil_suivi.SS_Traitance =
        this.isNanFunction(
          this.conceptions[1].Tab_190.Ouverture_chantier.Conseil_suivi.SS_Traitance
        );
      ...
      this.Tab_190.Ouverture_chantier.Aleas.SS_Traitance =
        ...
        this.Tab_190.Ouverture_chantier.Achat_Terrain.SS_Traitance =
        this.isNanFunction(
          this.conceptions[1].Tab_190.Ouverture_chantier.Achat_Terrain.SS_Traitance
        );
        this.Tab_190.Ouverture_chantier.Frais_notaire.SS_Traitance =
        this.isNanFunction(
          this.conceptions[1].Tab_190.Ouverture_chantier.Frais_notaire.SS_Traitance
        );
    }
    ...
    this.Tab_190.Ouverture_chantier.Sous_Total_Construction = 0;
    var s0 = this.isNanFunction(
      this.Tab_190.Ouverture_chantier.Sous_Total_Construction
    );
    return (this.Tab_190.Ouverture_chantier.Sous_Total_Construction =
      ssTraitance1 + ssTraitance2 + ssTraitance3 + ssTraitance4);
  }
  somePrixDeVneteTotaux_TAB1(){
    var x= this.Tab_190.Ouverture_chantier.Sous_Total_Prix_vente = this.isNanFunction(this.Tab_190.Ouverture_chantier.Frais_notaire.marge_totale) +

    this.isNanFunction(this.Tab_190.Ouverture_chantier.Frais_notaire.SS_Traitance)
 console.log("YYYYYYYYYYYYYYYYYY", x);

    return (this.Tab_190.Ouverture_chantier.Sous_Total_Prix_vente =   this.Tab_190.Ouverture_chantier.Frais_notaire.marge_totale +

 this.Tab_190.Ouverture_chantier.Frais_notaire.SS_Traitance);


    // if (
    //   this.Tab_190.Ouverture_chantier.Controle_technique_SPS.Prix_vente_Concep == null ||
    //   this.Tab_190.Ouverture_chantier.Controle_technique_SPS.Prix_vente_Concep == ""
    // ) {
    //   this.Tab_190.Ouverture_chantier.Controle_technique_SPS.Prix_vente_Concep =
    //   this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Controle_technique_SPS.Prix_vente_Concep);

    //   this.Tab_190.Ouverture_chantier.Frais_dossier.Prix_vente_Concep =
    //   this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Frais_dossier.Prix_vente_Concep);

    //   this.Tab_190.Ouverture_chantier.Conseil_suivi.Prix_vente_Concep =
    //   this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Conseil_suivi.Prix_vente_Concep);

    //   this.Tab_190.Ouverture_chantier.Aleas.Prix_vente_Concep =
    //   this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Aleas.Prix_vente_Concep);
    //   this.Tab_190.Ouverture_chantier.TRCME.Prix_vente_Concep =
    //   this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.TRCME.Prix_vente_Concep);
    //   this.Tab_190.Ouverture_chantier.Achat_Terrain.Prix_vente_Concep =
    //   this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Achat_Terrain.Prix_vente_Concep);
    //   this.Tab_190.Ouverture_chantier.Frais_notaire.Prix_vente_Concep  =
    //   this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Frais_notaire.Prix_vente_Concep );
    ...
    // this.Tab_190.Ouverture_chantier.Sous_Total_Prix_vente = 0;
    // var s0 = this.isNanFunction(
    //   this.Tab_190.Ouverture_chantier.Sous_Total_Prix_vente
    // )
    //   ? this.isNanFunction(
    //       this.Tab_190.Ouverture_chantier.Sous_Total_Prix_vente
    //     )
    //   : this.isNanFunction(this.conceptions[1].Tab_190.Ouverture_chantier.Sous_Total_Prix_vente);
    //   console.log("nooooooo",this.Tab_190.Ouverture_chantier.Sous_Total_Prix_vente);
  ...
  sommeSoutraitanceTotaux_TAB2() {
    if (
      ...
      this.Tab_190.Lot_1_Process_methanisation.Process_methanisation.SS_Traitance =
        this.conceptions[1].Tab_190.Lot_1_Process_methanisation.Process_methanisation.SS_Traitance;

      this.Tab_190.Lot_1_Process_methanisation.Pieces_usure_premiere_urgence_Lot_1.SS_Traitance =
        this.conceptions[1].Tab_190.Lot_1_Process_methanisation.Pieces_usure_premiere_urgence_Lot_1.SS_Traitance;
  ...
  somePrixDeVneteTotaux_TAB2() {
    this.Tab_190.Lot_1_Process_methanisation.Sous_Total_Prix_vente = 0;
    return (this.Tab_190.Lot_1_Process_methanisation.Sous_Total_Prix_vente =
      this.isNanFunction(
        this.Tab_190.Lot_1_Process_methanisation.Sous_Total_Prix_vente
      ) +
      this.isNanFunction(
        this.Tab_190.Lot_1_Process_methanisation.Process_methanisation
          .Prix_vente_Concep
  ...
  sommeDeMarge_TAB3() {
    ...
    var ssTraitance = this.isNanFunction(
      ...
      : this.isNanFunction(
          this.conceptions[1].Tab_190.Lot_2_Valorisation.Process_methanisation
            .SS_Traitance
        );
  ...
  sommeSoutraitanceTotaux_TAB3() {
    if (
      ...
      this.Tab_190.Lot_2_Valorisation.Epuration_Compression_Chaudiere.SS_Traitance =
        this.conceptions[1].Tab_190.Lot_2_Valorisation.Epuration_Compression_Chaudiere.SS_Traitance;

      this.Tab_190.Lot_2_Valorisation.Cogenerateur.SS_Traitance =
        this.conceptions[1].Tab_190.Lot_2_Valorisation.Cogenerateur.SS_Traitance;
    }
  ...
  somePrixDeVneteTotaux_TAB3() {
    this.Tab_190.Lot_2_Valorisation.Sous_Total_Prix_vente = 0;
    return (this.Tab_190.Lot_2_Valorisation.Sous_Total_Prix_vente =
      this.isNanFunction(
        this.Tab_190.Lot_2_Valorisation.Sous_Total_Prix_vente
      ) +
      this.isNanFunction(
        this.Tab_190.Lot_2_Valorisation.Epuration_Compression_Chaudiere
          .Prix_vente_Concep
  ...
  sommeSoutraitanceTotaux_TAB4() {
    if (
      ...
      this.Tab_190.Lot_3_Terrassement_Grande_Masse_Talutage_VRD.Terrassement_Grande_Masse_Talutafe_VRD.SS_Traitance =
        this.conceptions[1].Tab_190.Lot_3_Terrassement_Grande_Masse_Talutage_VRD.Terrassement_Grande_Masse_Talutafe_VRD.SS_Traitance;
    }
  ...
  somePrixDeVneteTotaux_TAB4() {
    this.Tab_190.Lot_3_Terrassement_Grande_Masse_Talutage_VRD.Sous_Total_Prix_vente = 0;
...
sommeSoutraitanceTotaux_TAB5() {
  if (
    ...
    this.Tab_190.Lot_4_Genie_Civil_circulaire_digestat_liquide_couverture_simple.Genie_Civil_circulaire_digestat_liquide_couverture_simple.SS_Traitance =
      this.conceptions[1].Tab_190.Lot_4_Genie_Civil_circulaire_digestat_liquide_couverture_simple.Genie_Civil_circulaire_digestat_liquide_couverture_simple.SS_Traitance;
  }
...
somePrixDeVneteTotaux_TAB5() {
  this.Tab_190.Lot_4_Genie_Civil_circulaire_digestat_liquide_couverture_simple.Sous_Total_Prix_vente = 0;
  ...
  sommeSoutraitanceTotaux_TAB6() {
    if (
      ...
      this.Tab_190.Lot_5_Genie_Civil_ouvrages_peripheriques.Genie_Civil_ouvrages_peripheriques.SS_Traitance =
        this.conceptions[1].Tab_190.Lot_5_Genie_Civil_ouvrages_peripheriques.Genie_Civil_ouvrages_peripheriques.SS_Traitance;
    }
  ...
  somePrixDeVneteTotaux_TAB6() {
    ...
    sommeSoutraitanceTotaux_TAB7() {
      if (
        ...
        this.Tab_190.Lot_6_Charpente_Batiment_Couverture.Charpente_Batiment_Couverture.SS_Traitance =
          this.conceptions[1].Tab_190.Lot_6_Charpente_Batiment_Couverture.Charpente_Batiment_Couverture.SS_Traitance;
      }
    ...
    somePrixDeVneteTotaux_TAB7() {
      this.Tab_190.Lot_6_Charpente_Batiment_Couverture.Sous_Total_Prix_vente = 0;
    ...
    sommeSoutraitanceTotaux_TAB8() {
      if (
        ...
        this.Tab_190.Lot_7_Courant_fort_Soutirage_Electricite_Generale.Courant_fort_Soutirage_Electricite_Generale.SS_Traitance =
          this.conceptions[1].Tab_190.Lot_7_Courant_fort_Soutirage_Electricite_Generale.Courant_fort_Soutirage_Electricite_Generale.SS_Traitance;
      }
    ...
    somePrixDeVneteTotaux_TAB8() {
      this.Tab_190.Lot_7_Courant_fort_Soutirage_Electricite_Generale.Sous_Total_Prix_vente = 0;
  ...
  somePrixDeVneteTotaux_TAB9() {
    this.Tab_190.Maitrise_oevre.Sous_Total_Prix_vente = 0;
    return (this.Tab_190.Maitrise_oevre.Sous_Total_Prix_vente =
      this.isNanFunction(
        this.Tab_190.Maitrise_oevre.Sous_Total_Prix_vente
      ) +
      this.isNanFunction(
  ...
  sommeSoutraitanceTotaux_TAB10() {
    if (
      ...
      this.Tab_190.Assistance_maitrise_ouvrage.AMO.SS_Traitance =
        this.conceptions[1].Tab_190.Assistance_maitrise_ouvrage.AMO.SS_Traitance;
    }
  ...
  somePrixDeVneteTotaux_TAB10() {
    this.Tab_190.Assistance_maitrise_ouvrage.Sous_Total_Prix_vente = 0;
    return (this.Tab_190.Assistance_maitrise_ouvrage.Sous_Total_Prix_vente =
      this.isNanFunction(
        this.Tab_190.Assistance_maitrise_ouvrage.Sous_Total_Prix_vente
      ) +
      this.isNanFunction(
    ...
    somme_privVente_TAB11() {
      if (
        ...
        this.Tab_190.Lot_1_Process_methanisation.Matrriels_agricoles.marge_totale =
          this.isNanFunction(
            this.conceptions[1].Tab_190.Matrriels_agricoles.Process_methanisation
              .marge_totale
          );
      }
      ...
      return (this.Tab_190.Lot_1_Process_methanisation.Matrriels_agricoles.Prix_vente_Concep =
        this.isNanFunction(ssTraitance + marge_totale));
    }
    ...
    somme_privVente_2TAB1() {
     ...
     return(this.Tab_190.Materiel.Pont_bascule_Reserve_Incendie.Prix_vente_Concep =
        this.isNanFunction(
          this.Tab_190.Materiel.Pont_bascule_Reserve_Incendie.marge_totale
        ) +
        this.isNanFunction(
    ...
    sommeSoutraitanceTotaux_TAB11() {
      if (
        ...
        this.Tab_190.Materiel.Pont_bascule_Reserve_Incendie.SS_Traitance =
          this.conceptions[1].Tab_190.Materiel.Pont_bascule_Reserve_Incendie.SS_Traitance;
    ...
    somePrixDeVneteTotaux_TAB11() {
      this.Tab_190.Materiel.Sous_Total_Prix_vente = 0;
      return (this.Tab_190.Materiel.Sous_Total_Prix_vente =
        this.isNanFunction(this.Tab_190.Materiel.Sous_Total_Prix_vente) +
        this.isNanFunction(
    ...
    SommeTotal_totaux_SS_Traitance(){
      this.totaux_SS_traitance_Total_190=0
      console.log("rrrrrrrr",this.totaux_SS_traitance_Total_190);

     return (this.totaux_SS_traitance_Total_190=
      this.isNanFunction(this.Tab_190.Ouverture_chantier.Sous_Total_Construction)+
      this.isNanFunction(this.Tab_190.Lot_1_Process_methanisation.Sous_Total_Construction)+
      this.isNanFunction(this.Tab_190.Lot_2_Valorisation.Sous_Total_Construction)+
      this.isNanFunction(this.Tab_190.sercurisation_gaziers.Sous_Total_Construction)+
      this.isNanFunction(this.Tab_190.Lot_4_Genie_Civil_circulaire_digestat_liquide_couverture_simple.Sous_Total_Construction)+
      this.isNanFunction(this.Tab_190.Lot_5_Genie_Civil_ouvrages_peripheriques.Sous_Total_Construction)+
      this.isNanFunction(this.Tab_190.Lot_6_Charpente_Batiment_Couverture.Sous_Total_Construction)+

      this.isNanFunction(this.Tab_190.Lot_7_Courant_fort_Soutirage_Electricite_Generale.Sous_Total_Construction)+
      this.isNanFunction(this.Tab_190.Maitrise_oevre.Sous_Total_Construction)+
      this.isNanFunction(this.Tab_190.Assistance_maitrise_ouvrage.Sous_Total_Construction)+
      this.isNanFunction(this.Tab_190.Materiel.Sous_Total_Construction)

     );
    }
    SommeTotal_totaux_Prix_Vente_totaux(){
      this.totaux_prixVente_Total_190=0
      return (this.totaux_prixVente_Total_190=
       this.isNanFunction(this.Tab_190.Ouverture_chantier.Sous_Total_Prix_vente)+
       this.isNanFunction(this.Tab_190.Lot_1_Process_methanisation.Sous_Total_Prix_vente)+
       this.isNanFunction(this.Tab_190.Lot_2_Valorisation.Sous_Total_Prix_vente)+
       this.isNanFunction(this.Tab_190.Lot_3_Terrassement_Grande_Masse_Talutage_VRD.Sous_Total_Prix_vente)+
       this.isNanFunction(this.Tab_190.Tab_190.Lot_4_Genie_Civil_circulaire_digestat_liquide_couverture_simple.Sous_Total_Prix_vente)+
       this.isNanFunction(this.Tab_190.Lot_5_Genie_Civil_ouvrages_peripheriques.Sous_Total_Prix_vente)+
       this.isNanFunction(this.Tab_190.Lot_6_Charpente_Batiment_Couverture.Sous_Total_Prix_vente)
       +
       this.isNanFunction(this.Tab_190.Lot_7_Courant_fort_Soutirage_Electricite_Generale.Sous_Total_Prix_vente)+
       this.isNanFunction(this.Tab_190.Maitrise_oevre.Sous_Total_Prix_vente)+
       this.isNanFunction(this.Tab_190.Assistance_maitrise_ouvrage.Sous_Total_Prix_vente)+
       this.isNanFunction(this.Tab_190.Materiel.Sous_Total_Prix_vente)

      );
    }
    SommeTotal_totaux_Marge_totaux(){
      this.totaux_marge_Total_190=0
      return (this.totaux_marge_Total_190=
       ...
       this.isNanFunction(this.Tab_190.Lot_2_Valorisation.Marge_totaux)+
       this.isNanFunction(this.Tab_190.sercurisation_gaziers.Marge_totaux)+
