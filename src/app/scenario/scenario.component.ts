...
export class ScenarioComponent implements OnInit {
  ...
  addFiche(value) {
    this.agriSrv.addFicheClient(value).subscribe((data: any) => {
      console.log("fiche added to bd ", value);
    });
  }
  ...
  getFichesInfo() {
    this.agriSrv.getfichesInfo().subscribe((data: any) => {
      this.infos = data;
console.log("getallinfo",this.infos);
  ...
  saveContent(value) {
    ...
    this.t_MB_an = v.t_MB_an = this.prod.toFixed(2);
    ...
    // this.Interet_porteur_projet.Total_ss_traitance =
    ...
    //     .SS_Traitance;
    // console.log("bb", this.Interet_porteur_projet.Total_ss_traitance);
